...
//                    Method m = clz.getDeclaredMethod(mn);
//                    Object rel = m.invoke(obj);
                et.createCell(ReflectionUtils.getFieldValue(obj, mn));
            }
        }
...
//            e.printStackTrace();
            ...
            logger.error(String.format(" [ Excel Error ] 创建Workbook异常 " + e));
//            e.printStackTrace();
        }
        return null;
    }
...
//                    BeanUtils.copyProperty(obj, mn, this.getCellValue(cell));
                    ReflectionUtils.setFieldValue(obj, mn, this.getCellValue(cell));
                }
                objs.add(obj);
            }
