...
public class ExcelModel implements Serializable {
    ...
    /**
     * BeanUtils不支持String类型,数据库为TimeStamp
     * Job完成时间限制
     */
    private Date jobReqTime;
    /**
     * Job优先级
     */
    ...
    public Date getJobReqTime() {
        return jobReqTime;
    }

    public void setJobReqTime(Date jobReqTime) {
...
//        }
    ...
    public ExcelModel(String triggerName, String triggerGroup, Date jobReqTime, String jobPri,
                      String remark) {
        this.triggerName = triggerName;
        this.triggerGroup = triggerGroup;
        this.jobReqTime = jobReqTime;
